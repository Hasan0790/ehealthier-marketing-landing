...
$("#demoRequestForm").on('submit', function(e) {
    e.preventDefault();
    var form = $(this);
    var statusSuccess = $('#demoFormSuccess');
    var statusError = $('#demoFormError');
    ...
    formData['_submittedAt'] = new Date().toLocaleString();
...
/* ==========================================
   NEWSLETTER FORM (Lambda)
============================================= */
$("#newsletterForm").on('submit', function(e) {
    e.preventDefault();
    var form = $(this);
    var statusSuccess = $('#newsletterSuccess');
    var statusError = $('#newsletterError');
    ...
    $.ajax({
        ...
        dataType: "json",
        success: function(data) {
            form.find('input').val(''); // Clear form fields
            statusSuccess.fadeIn(1000);
            statusError.hide();
            setTimeout(function() {
                statusSuccess.fadeOut(1000);
...
/* ==========================================
   QUOTE FORM
============================================= */
$("#quoteForm2").on('submit', function(e) {
    e.preventDefault();
    var data = {
        name: $("#qName").val(),
        email: $("#qEmail").val(),
